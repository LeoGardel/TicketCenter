...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { description: @projeto.description, initial_date: @projeto.initial_date, name: @projeto.name } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { description: @projeto.description, initial_date: @projeto.initial_date, name: @projeto.name } }
